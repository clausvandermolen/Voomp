    ...
    <div style={{ fontFamily: "'Nunito Sans', -apple-system, BlinkMacSystemFont, sans-serif", color: "#222", background: "#fff", overflowX: "hidden" }}>
      ...
      {showWelcome && (
        <div style={{ position: "fixed", inset: 0, zIndex: 1100, display: "flex", alignItems: "center", justifyContent: "center" }} onClick={() => setShowWelcome(false)}>
          ...
          <div onClick={e => e.stopPropagation()} style={{ position: "relative", background: "#fff", borderRadius: 20, width: isMobile ? "90vw" : "min(460px, 90vw)", padding: isMobile ? "36px 24px" : "44px 36px", textAlign: "center", boxShadow: "0 24px 60px rgba(0,0,0,.3)", animation: "fadeUp .5s ease-out" }}>
            ...
            <img src="/logo.png" alt="Voomp" style={{width:56, height:56, borderRadius:16}} />
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: isMobile ? "12px 16px" : "16px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", background: navBg, backdropFilter: scrollY > 50 ? "blur(12px)" : "none", borderBottom: navBorder, transition: "all .3s" }}>
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 12 : 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <img src="/logo.png" alt="Voomp" style={{width: isMobile ? 32 : 36, height: isMobile ? 32 : 36, borderRadius:10}} />
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0 }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: `linear-gradient(180deg, rgba(26,60,94,.55) 0%, rgba(26,60,94,.35) 50%, rgba(26,60,94,.75) 100%)` }} />
        </div>
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: 780, padding: isMobile ? "0 20px" : "0 24px", animation: "fadeUp .8s ease-out", width: "100%" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(255,255,255,.12)", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,.25)", borderRadius: 100, padding: "6px 14px", marginBottom: isMobile ? 16 : 20 }}>
            <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#4ADE80", animation: "pulse 2s infinite" }} />
            <span style={{ fontSize: isMobile ? 12 : 13, color: "rgba(255,255,255,.9)", fontWeight: 600 }}>Disponible en Santiago</span>
          </div>
          <h1 style={{ fontSize: isMobile ? 34 : 56, fontWeight: 800, color: "#fff", lineHeight: 1.15, marginBottom: isMobile ? 14 : 20, letterSpacing: isMobile ? -0.5 : -1 }}>
            Tu vecino tiene{" "}
            <span style={{ background: BRAND_GRADIENT, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>tu lugar.</span>
          </h1>
      ...
      <section style={{ maxWidth: 1120, margin: "0 auto", padding: isMobile ? "60px 20px" : "100px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: isMobile ? 36 : 56 }}>
          ...
          <h2 style={{ fontSize: isMobile ? 26 : 38, fontWeight: 800, marginTop: 12, letterSpacing: -.5, color: NAVY }}>Estacionar nunca fue tan fácil</h2>
      ...
      <section style={{ background: "#fafafa", padding: isMobile ? "60px 20px" : "100px 24px" }}>
        <div style={{ maxWidth: 1120, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: isMobile ? 36 : 56 }}>
            ...
            <h2 style={{ fontSize: isMobile ? 26 : 38, fontWeight: 800, marginTop: 12, letterSpacing: -.5, color: NAVY }}>Tres pasos y listo</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit, minmax(280px, 1fr))", gap: isMobile ? 28 : 40 }}>
            {steps.map((s, i) => (
              <div key={i} style={{ textAlign: "center" }}>
                ...
                <h3 style={{ fontSize: isMobile ? 19 : 22, fontWeight: 700, marginBottom: 10, color: NAVY }}>{s.title}</h3>
      ...
      <section style={{ padding: isMobile ? "60px 20px" : "100px 24px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", background: BRAND_GRADIENT, borderRadius: isMobile ? 20 : 28, padding: isMobile ? "48px 24px" : "72px 40px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: isMobile ? 10 : 16, position: "relative", flexDirection: isMobile ? "column" : "row", alignItems: "center" }}>
            ...
            <button onClick={openMapModal} style={{ padding: isMobile ? "16px 24px" : "16px 36px", borderRadius: 12, border: "1px solid rgba(255,255,255,.4)", background: "transparent", color: "#fff", fontSize: isMobile ? 16 : 17, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", transition: "all .2s", width: isMobile ? "100%" : "auto", maxWidth: isMobile ? 320 : "none" }}>
              Explorar espacios
            </button>
          </div>
        </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 24, flexDirection: isMobile ? "column" : "row", marginBottom: 28 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                <img src="/logo.png" alt="Voomp" style={{width:28, height:28, borderRadius:8}} />
